...
export function ProductsList({
  ...
  const [filterType, setFilterType] = useState<"all" | "service" | "equipment">(
    "all"
  );
  ...
  // Filter logic - moved up before the selectedProductIds calculation
  const filteredData = React.useMemo(() => {
    return (products as OptimisticProduct[]).filter((product) => {
      // Include products being optimistically deleted, but with visual indication
      const matchesSearch =
  ...
  // Convert rowSelection to an array of product IDs - now filteredData is defined before it's used
  ...
  const handleBulkDelete = () => {
    if (selectedProductIds.length > 0 && onBulkDeleteProducts) {
      try {
        // Apply bulk delete
  ...
  const getRowStyles = (row: OptimisticProduct) => {
    ...
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="p-4 border-b border-gray-200">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <Select
            value={filterType}
            onValueChange={(value: "all" | "service" | "equipment") =>
              setFilterType(value)
            }
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="service">
                {t("products.filter.service")}
              </SelectItem>
              <SelectItem value="equipment">
                {t("products.filter.equipment")}
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
            ...
            {!onLoadMore && (
              <div className="flex items-center space-x-1">
                ...
                <span className="mx-2 text-sm text-gray-700">
                  ...
                  {t("products.pagination.of")} {table.getPageCount() || 1}
                </span>
                <Button
                  variant="outline"
                  size="sm"
