...
interface ServiceOrderQuickAddModalProps {
  onClose: () => void;
  onSave: (orderData: {
    title: string;
    client: string;
...
export function ServiceOrderQuickAddModal({
  onClose,
  onSave,
  isSaving,
}: ServiceOrderQuickAddModalProps) {
      ...
      <div className="bg-white rounded-lg w-full max-w-md">
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold">Nova O.S.</h2>
          </div>
          <button
            onClick={onClose}
            disabled={isSaving}
